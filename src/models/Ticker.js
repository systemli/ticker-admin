...
export default class Ticker {
  constructor(props) {
    ...
    this.description =
      undefined !== props.description ? props.description : null
    this.active = undefined !== props.active ? props.active : false

    if (undefined !== props.information) {
      this.information = {
        author:
          undefined !== props.information.author
            ? props.information.author
            : null,
        url: undefined !== props.information.url ? props.information.url : null,
        email:
          undefined !== props.information.email
            ? props.information.email
            : null,
        twitter:
          undefined !== props.information.twitter
            ? props.information.twitter
            : null,
        facebook:
          undefined !== props.information.facebook
            ? props.information.facebook
            : null,
      }
    } else {
      this.information = {
    ...
    if (undefined !== props.twitter) {
      this.twitter = {
        ...
        screen_name:
          undefined !== props.twitter.screen_name
            ? props.twitter.screen_name
            : null,
        description:
          undefined !== props.twitter.description
