...
export default class Message extends React.Component {
  ...
  deleteMessage() {
    deleteMessage(
      this.props.message.ticker.toString(),
      this.props.message.id.toString()
    ).then(() => {
  ...
  renderMap() {
    ...
    return (
      <Map center={[0, 0]} zoom={1}>
        ...
        <GeoJSON
          data={JSON.parse(this.props.message.geo_information)}
          onAdd={this.onGeoInformationAdded}
        />
      </Map>
    )
  }
        ...
        <Card.Content>
          ...
          <p
            dangerouslySetInnerHTML={{
              __html: this._replaceMagic(this.props.message.text),
            }}
          />
        </Card.Content>
